...
object ActivityNavigator
{
 ...
 fun startNewTaskActivity(mContext: Context, cls: Class<*>) {
    ...
    fun startActivityForResult(mContext: Context, cls: Class<*>, bundle: Bundle, requestCode: Int) {
        val mainIntent = Intent(mContext, cls)
        mainIntent.putExtras(bundle)
        (mContext as AppCompatActivity).startActivityForResult(mainIntent, requestCode)
    }
    fun startActivityForResult(mContext: Context, cls: Class<*>, requestCode: Int) {
        val mainIntent = Intent(mContext, cls)
        (mContext as AppCompatActivity).startActivityForResult(mainIntent, requestCode)
    }
...
/*
    fun startActivityWithTransition(cls: Class<*>, options: ActivityOptionsCompat) {
        val mainIntent = Intent(mContext, cls)
